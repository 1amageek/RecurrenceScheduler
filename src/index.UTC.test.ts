  ...
  describe("Monthly", () => {
    ...
    describe("1 month", () => {
      ...
      test("occurrenceDateがRangeのLowerよりも小さい", () => {
        ...
        expect(calendarItems[2].period[0]).toEqual(new Date("2021-01-08T08:00:00.000Z"))
        expect(calendarItems[2].period[1]).toEqual(new Date("2021-01-08T17:00:00.000Z"))
        expect(calendarItems[3].period[0]).toEqual(new Date("2021-01-09T08:00:00.000Z"))
        expect(calendarItems[3].period[1]).toEqual(new Date("2021-01-09T17:00:00.000Z"))
        expect(calendarItems.length).toEqual(4)
      })
      ...
      test("occurrenceDateがRangeのLowerより大きい", () => {
        ...
        const calendarItems = RecurrenceScheduler.calendarItems(item, [start, end])
        expect(calendarItems[0].period[0]).toEqual(new Date("2021-01-07T08:00:00.000Z"))
        expect(calendarItems[0].period[1]).toEqual(new Date("2021-01-07T17:00:00.000Z"))
        expect(calendarItems[1].period[0]).toEqual(new Date("2021-01-08T08:00:00.000Z"))
        expect(calendarItems[1].period[1]).toEqual(new Date("2021-01-08T17:00:00.000Z"))
        expect(calendarItems[2].period[0]).toEqual(new Date("2021-01-09T08:00:00.000Z"))
        expect(calendarItems[2].period[1]).toEqual(new Date("2021-01-09T17:00:00.000Z"))
        expect(calendarItems.length).toEqual(3)
      })
  ...
  describe("Yearly", () => {
    ...
    describe("2 years", () => {
      ...
      test("occurrenceDateがRangeのLowerよりも小さい", () => {
        ...
        expect(calendarItems[3].period[0]).toEqual(new Date("2021-01-09T08:00:00.000Z"))
        expect(calendarItems[3].period[1]).toEqual(new Date("2021-01-09T17:00:00.000Z"))
        expect(calendarItems[4].period[0]).toEqual(new Date("2022-01-06T08:00:00.000Z"))
        expect(calendarItems[4].period[1]).toEqual(new Date("2022-01-06T17:00:00.000Z"))
        expect(calendarItems[5].period[0]).toEqual(new Date("2022-01-07T08:00:00.000Z"))
        expect(calendarItems[5].period[1]).toEqual(new Date("2022-01-07T17:00:00.000Z"))
        expect(calendarItems[6].period[0]).toEqual(new Date("2022-01-08T08:00:00.000Z"))
        expect(calendarItems[6].period[1]).toEqual(new Date("2022-01-08T17:00:00.000Z"))
        expect(calendarItems[7].period[0]).toEqual(new Date("2022-01-09T08:00:00.000Z"))
        expect(calendarItems[7].period[1]).toEqual(new Date("2022-01-09T17:00:00.000Z"))
        expect(calendarItems.length).toEqual(8)
      })
